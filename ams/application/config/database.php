...
$db['default']['username'] = 'cas4';
$db['default']['password'] = '$%rtFGvb';
$db['default']['database'] = 'cas_mysql';
...
$db['moodle']['username'] = 'tntemple1';
$db['moodle']['password'] = '!@qwASzx';
$db['moodle']['database'] = 'tntemplelms';
