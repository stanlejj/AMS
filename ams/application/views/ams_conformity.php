<div id="page_content">
		<div id="content_wrapper" class="center-layout">
			...
			<div class='title'>
				<h2>Conformity Analysis</h2>
			</div>
			<div id="filter_criteria" class="filter ui-widget ui-widget-content ui-corner-all">				
				<!--filter sections - with tab sliding effect-->
				<ul class='filter-tab'>
					<li id="system_c" rel="filter_system_c"></li>
					<li id="rule" rel="filter_rule"></li>
				</ul>
				<div id="filter_system_c" class="filter-selection">
					<div>
						<select>
				...
				<div id="filter_rule" class="filter-selection">
					<div>
						&nbsp;
					</div>
					<div>
